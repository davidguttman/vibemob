...
async function _prepareAndRunAider(userId, prompt) {
  ...
  const aiderOptions = {
    ...
    prompt: finalPrompt, // Use the original user prompt
    editableFiles: editableFiles, // Pass editable files separately
    readOnlyFiles: readOnlyFiles, // Pass read-only files separately
  };
...
export const coreService = {
  ...
  getContextFiles, // <-- Export the new function
