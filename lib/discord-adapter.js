...
// Conditionally import Discord components based on NODE_ENV
let Client, Events, GatewayIntentBits, AttachmentBuilder, SlashCommandBuilder, EmbedBuilder;
if (process.env.NODE_ENV === 'test') {
  // In test, import from the local index which uses the double
  ({ Client, Events, GatewayIntentBits, AttachmentBuilder, SlashCommandBuilder, EmbedBuilder } = await import('./discord/index.js'));
} else {
  // In production/development, import directly from discord.js
  ({ Client, Events, GatewayIntentBits, AttachmentBuilder, SlashCommandBuilder, EmbedBuilder } = await import('discord.js'));
}
