...
async function sendPromptToAider(options) {
  ...
  try {
    ...
    const runAiderOptions = {
        ...
        autoCommits: true, // Explicitly enable auto-commit based on README
        // verbose: options.verbose || false,
    };

    // --> ADD LOGGING
    // log('>>> Calling runAider with options:', JSON.stringify(runAiderOptions, null, 2)); // REMOVE DEBUG LOG
