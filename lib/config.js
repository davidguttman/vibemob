...
// const envPath = path.resolve(__dirname, '../.env'); // REMOVE
// Only load .env file if not in test environment
/* // REMOVE dotenv logic block
...
const config = {
  ...
  discordGuildId: process.env.GUILD_ID, // Add GUILD_ID
  discordRoleId: process.env.AUTHORIZED_ROLE_ID, // Add AUTHORIZED_ROLE_ID
  discordLoggingChannelId: process.env.LOGGING_CHANNEL_ID, // Add LOGGING_CHANNEL_ID
...
const requiredVars = ['discordBotToken', 'discordBotUserId', 'aiderApiKey', 'repoUrl'];
